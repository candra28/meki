...
-- === SETTINGS ===
local checkpoints = {
    Vector3.new(640, 123, 843), -- CP1
    Vector3.new(1790, 245, 1447),  -- CP2
    Vector3.new(2368, 426, 1444),  -- CP3
    Vector3.new(2761, 414, 1312),  -- CP4
    Vector3.new(3463, 349, 1416), -- CP5
    Vector3.new(4551, 249, 1392),-- CP6
    Vector3.new(5268, 361, 988), -- CP7
    Vector3.new(5238, 509, 474),  -- CP8
    Vector3.new(4729, 729, 176)  -- CP9
    Vector3.new(4594, 633, -301), -- CP10
    Vector3.new(4736, 701, -946),  -- CP11
    Vector3.new(5362, 700, -1720),  -- CP12
    Vector3.new(5899, 705, -2259),  -- CP13
    Vector3.new(6374, 653, -2498), -- CP14
    Vector3.new(7311, 985, -2878),-- CP15
    Vector3.new(7840, 1205, -3284), -- CP16
    Vector3.new(8183, 1243, -5050),  -- CP17
    Vector3.new(878, 1169, -5281)  -- CP18
    Vector3.new(7644, 1169, -5608),  -- CP19
    Vector3.new(7589, 1168, -5988),  -- CP20
    Vector3.new(6959, 1933, -7753)  -- CP21 Summit
}
